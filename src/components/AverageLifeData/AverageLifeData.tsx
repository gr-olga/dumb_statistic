import {CHILDHOOD_COLOR, RETIREMENT_COLOR, SCHOOL_COLOR, UNIVERSITY_COLOR, WORK_COLOR} from '../WeeksCount/WeeksCount';
  ...
  return (
      <div className={styles.info_container}>
        <div className={styles.info_item}>
          <p className={styles.info_text}>Childhood:<span> 0-6 years</span></p>
